...
logic [3:0] FpgaPins_Fpga_CALC_digit_a4;
      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            if (1) begin : P_calc
               ...
               (* keep *) logic [3:0] \///@4$digit ;
               assign \///@4$digit = FpgaPins_Fpga_CALC_digit_a4;
...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 194 as: m5+tt_connections()
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 197 as: m5+board(/top, /fpga, 7, $, , calc)
               ...
               //_|calc
                  ...
                  //_@2
                     assign FpgaPins_Fpga_CALC_out_a2[7:0] =
                        ...
                        FpgaPins_Fpga_CALC_op_a2 == 3'b000 ? FpgaPins_Fpga_CALC_sum_a2[7:0] :
                        FpgaPins_Fpga_CALC_op_a2 == 3'b001 ? FpgaPins_Fpga_CALC_diff_a2[7:0] :
                        FpgaPins_Fpga_CALC_op_a2 == 3'b010 ? FpgaPins_Fpga_CALC_prod_a2[7:0] :
                        FpgaPins_Fpga_CALC_op_a2 == 3'b011 ? FpgaPins_Fpga_CALC_quot_a2[7:0] :
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 199 as: m5+tt_input_labels_viz(⌈"Value[0]", "Value[1]", "Value[2]", "Value[3]", "Op[0]", "Op[1]", "Op[2]", "="⌉)
